   ...
   return (
      ...
      >
         <div className="w-full h-screen flex flex-col gap-10 justify-center items-center">
            {/* ================= Hero Title ================= */}
            <div className="flex flex-col items-center text-[7rem] font-semibold leading-none">
               <div>
                  Hello
                  <span className="px-8">
                     <div
                        ...
                        style={{
                           backgroundImage:
                              "url(https://i.ibb.co/b5MZSFXw/1.jpg)",
                        }}
                     ></div>
                  </span>
                  I’m Vishal
            ...
            <div className="text-lg font-medium">
               Fueled by <i className="text-xl">coffee</i>, driven by
               <i className="text-xl"> design</i>, and occasionally found on the
               <i className="text-xl"> basketball court.</i>
            </div>
